...
look every single iterations. Lu et. al. tackle the question of not just
...
$\boldsymbol{c}$, which is the output of a trained image classification
network and provides visual features for caption generating. $\boldsymbol{c}$
is then fed into a LSTM unit, followed by a novel attention mechanism and a
